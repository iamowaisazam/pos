...
class StockAdjustmentController extends Controller
{
    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            foreach ($users as $key => $value) {
                ...
                $action .= '<a class="mx-1 btn btn-info" href="'.URL::to('/admin/stockadjustment/'.Crypt::encryptString($value->id)).'/edit">Edit</a>';
                
                $action .= '<a class="delete_btn mx-1 btn btn-danger" data-id="'.URL::to('admin/stockadjustment/'.Crypt::encryptString($value->id)).'">Delete</a>';
        ...
        return view('admin.stockadjustment.index',$data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.stockadjustment.create',$data);
    ...
    public function store(Request $request){
        ...
        return redirect(URL::to('/admin/stockadjustment/'.Crypt::encryptString($module->id).'/edit'))->with('success','Record Created');
    ...
    public function edit(Request $request,$id)
    {
        ...
        return view('admin.stockadjustment.edit',$data);
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect(URL::to('/admin/stockadjustment/'.Crypt::encryptString($model->id).'/edit'))->with('success','Record Updated');
