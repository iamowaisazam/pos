...
class SalePaymentController extends Controller
{
    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            foreach ($users as $key => $value) {
                ...
                $action .= '<a class="mx-1 btn btn-info" href="'.URL::to('/admin/salepayments/'.Crypt::encryptString($value->id)).'/edit">Edit</a>';

                $action .= '<a class="delete_btn mx-1 btn btn-danger" data-id="'.URL::to('admin/salepayments/'.Crypt::encryptString($value->id)).'">Delete</a>';
        ...
        return view('admin.salepayments.index',$data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.salepayments.create',$data);
    ...
    public function store(Request $request)
    {
        ...
        return redirect(URL::to('admin/salepayments/'))
    ...
    public function edit(Request $request,$id)
    {
        ...
        return view('admin.salepayments.edit',$data);
    }
