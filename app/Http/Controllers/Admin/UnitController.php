    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            foreach ($users as $key => $value) {
                ...
                $action .= '<a class="mx-1 btn btn-info" href="'.URL::to('/admin/units/'.Crypt::encryptString($value->id)).'/edit">Edit</a>';
                
                $action .= '<a class="delete_btn mx-1 btn btn-danger" data-id="'.URL::to('admin/units/'.Crypt::encryptString($value->id)).'">Delete</a>';
    ...
    public function store(Request $request){
        ...
        // dd($request->all());
            ...
            return redirect(URL::to('/admin/units/'.Crypt::encryptString($model->id).'/edit'))->with('success','Unit Created');
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect('/admin/units/')->with('success','Record Updated');
