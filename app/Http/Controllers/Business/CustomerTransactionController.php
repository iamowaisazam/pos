...
class CustomerTransactionController extends Controller
{
    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            foreach ($users as $key => $value) {
                ...
                $action .= '<a class="mx-1 btn btn-info" href="'.URL::to('/business/customer-transactions/'.Crypt::encryptString($value->id)).'/edit">Edit</a>';
                
                $action .= '<a class="delete_btn mx-1 btn btn-danger" data-id="'.URL::to('business/customer-transactions/'.Crypt::encryptString($value->id)).'">Delete</a>';
        ...
        return view('business.customer-transactions.index',$data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('business.customer-transactions.create',$data);
    ...
    public function store(Request $request)
    {
        ...
        return redirect(URL::to('business/customer-transactions/'))
    ...
    public function edit(Request $request,$id)
    {
        ...
        return view('business.customer-transactions.edit',$data);
    }
