...
class CategoryController extends Controller
{
    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            foreach ($users as $key => $value) {
                ...
                $action .= '<a class="mx-1 btn btn-info" href="'.URL::to('/business/categories/'.Crypt::encryptString($value->id)).'/edit">Edit</a>';
                
                $action .= '<a class="delete_btn mx-1 btn btn-danger" data-id="'.URL::to('business/categories/'.Crypt::encryptString($value->id)).'">Delete</a>';
    ...
    public function store(Request $request){
            ...
            return redirect(URL::to('/business/categories/'.Crypt::encryptString($model->id).'/edit'))->with('success','Record Created');
    ...
    public function edit(Request $request,$id)
    {
        ...
        return view('business.categories.edit',$data);
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect('/business/categories/')->with('success','Record Updated');
