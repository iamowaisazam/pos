...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"> Edit Sale Invoice
        </h4>
    </div>
...
<form method="post" class="myform" action="{{URL::to('business/saleinvoices')}}/{{Crypt::encryptString($sale->id)}}" >
@csrf
@method('PUT')
...
<div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{$sale->ref}}" name="ref" class="form-control" placeholder="Ref No" />
                                @if($errors->has('ref'))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input readonly value="{{$sale->tracking_id}}" name="tracking_id" class="form-control" placeholder="Tracking No" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="is_paid" class="form-control" >
                                    ...
                                    <option @if($sale->is_paid == 1 ) selected @endif
                                     value="1">Yes</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="customer">
                                    ...
                                    <option @if($sale->customer_id == '0') selected @endif value="0">Walk In Customer</option>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input value="{{$sale->description}}" name="description" class="form-control" placeholder="Description" />
        ...
        <section class="card">
            ...
            <div class="card-body"> 
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <input readonly name="subtotal" value="{{$sale->subtotal}}" class="subtotal form-control" />
                    </div>
               </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-10 additionals">
                        @foreach (json_decode($sale->adjustments) ?? [] as $key => $adjustment)
               ...
               <div class="row">
                    ...
                    <div class="col-md-10">
                        <input readonly  name="grandtotal" value="{{$sale->grandtotal}}" class="grandtotal form-control" />
                    </div>
              </div>
            </div>
        </section>
   ...
   <div class="col-lg-12 items-sections">
        <section class="card">
            ...
            <div class="card-body"> 
                <textarea name="notes" class="form-control" cols="30" rows="10">{{$sale->notes}}</textarea>
            </div>
        </section>
   </div>
