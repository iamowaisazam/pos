...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Transaction
        </h4>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        <form method="post" action="{{URL::to('business/vendor-transactions/'.Crypt::encryptString($model->id))}}" >
            @csrf
            @method('put')
            <div class="row">
                <div class="col-md-12">
                    <section class="card">
                        <header class="card-header bg-info">
                            <h4 class="mb-0 text-white">Edit</h4>
                        </header>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="vendor_id">
                                            ...
                                            @foreach ($vendors as $vendor)
                                                <option @if($model->vendor_id == $vendor->id) selected @endif value="{{$vendor->id}}"
                                                  >{{$vendor->name}}</option>
                                            @endforeach
                                        </select>
