                ...
                <header class="card-header bg-info">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end">
                            <a class="mx-1 btn btn-primary" href="{{URL::to('business/reports/inventoryReport')}}">Back</a>
                        </div>
                    </div>
                </header>
            <div class="card-body">    
...
@section('js')
       ...
       <?php $url = URL::to('business/reports/inventoryReportDetail/'.Crypt::encryptString($model->id));?>
