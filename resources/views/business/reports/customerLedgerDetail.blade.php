...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Customer Ledger</h4>
        </div>
                    ...
                    <header class="card-header bg-info">
                        <div class="row">
                            <div class="col-md-6 align-self-center">
                                <h4 class="mb-0 text-white">{{$model->name}} Ledger</h4>
                            </div>
...
@section('js')
       ...
       <?php $url = URL::to('business/reports/customerLedgerDetail/'.Crypt::encryptString($model->id));?>
