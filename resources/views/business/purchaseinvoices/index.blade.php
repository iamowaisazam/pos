...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Purchase Invoices 
            </h4>
        </div>
                ...
                <header class="card-header bg-info">
                    <div class="row">
                        <div class="col-md-6 align-self-center">
                            <h4 class="mb-0 text-white" >All Purchase Invoices List</h4>
                        </div>
                        <div class="col-md-6 text-end">
                            <a class="btn btn-primary" href="{{URL::to('business/purchaseinvoices/create')}}">Create New </a>
                        </div>
                    </div>
                </header>
                <div class="card-body">    
...
@section('js')
       ...
       <script>
        $(function () {
            ...
            ajax: {
                url: "{{URL::to('business/purchaseinvoices')}}",
                type: "GET",
                data: function ( d ) {  
