...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Purchase Invoice
        </h4>
    </div>
...
<form method="post" class="myform" action="{{URL::to('business/purchaseinvoices')}}" >
@csrf
                            ...
                            <div class="form-group">
                                ...
                                <select required class="form-control" name="vendor_id">
                                    ...
                                    @foreach ($vendors as $vendor)
                                        <option @if(old('vendor_id') == $vendor->id) selected @endif value="{{$vendor->id}}">{{$vendor->name}}</option>
                                    @endforeach
                                </select>
