<nav class="navbar top-navbar navbar-expand-md navbar-dark">
    <div class="navbar-header">
        <a class="navbar-brand" href="{{URL::to('/admin/dashboard')}}"><b>
             ...
             <img src="{{asset('/uploads/'.Auth::user()->business->icon)}}" class="light-logo" />
            </b>
            <span>
             {{-- <img src="{{asset('admin/assets/images/logo-text.png')}}" alt="homepage" class="dark-logo" /> --}}
             <img src="{{asset('/uploads/'.Auth::user()->business->logo)}}" class="light-logo" />
            </span> 
        </a>
    </div>
        ...
        <ul class="navbar-nav my-lg-0">
            <li class="nav-item dropdown u-pro">
                ...
                <div class="dropdown-menu dropdown-menu-end animated flipInY">
                    <a href="{{URL::to("business/profile")}}" class="dropdown-item">
                        <i class="ti-user"></i> My Profile
                    </a>
                    <a href="{{URL::to('/business/logout')}}" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                </div>
            </li>
        </ul>
    </div>
