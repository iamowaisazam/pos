                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" value="{{$settings['icon']}}" class="form-control" name="icon" />
                                @if($settings['icon'])
                                <img src="{{asset('/uploads/'.$settings['icon'])}}" style="border:1px solid;width:100px;height:100px"  />
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                @if($settings['logo'])
                                <img src="{{asset('/uploads/'.$settings['logo'])}}" style="border:1px solid; width:100px;height:100px"  />
                                @endif
                            </div>
                        </div> 
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Phone</label>
                                <input type="text" value="{{$settings['contact']}}" class="form-control" name="contact" />
                            </div>
                        </div>  
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Website</label>
                                <input type="text" value="{{$settings['website']}}" class="form-control" name="website" />
                            </div>
                        </div> 
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="details" class="form-control" rows="5">{{$settings['details']}}</textarea>
                            </div>
                        </div>  
